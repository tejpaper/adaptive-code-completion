...
def main() -> None:
    ...
    num_gen_layers = 6
    cache_file = f'scripts/cache/split_memory_profiling/mem_grid_generator_{num_gen_layers}.pt'
    plot_file = f'scripts/viz/split_memory_profiling/mem_grid_generator_{num_gen_layers}.png'
